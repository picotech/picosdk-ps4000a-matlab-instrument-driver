...
%This function was generated by loadlibrary.m parser version  on Mon Dec  7 12:03:21 2015
%perl options:'ps4000aApi.i -outfile=ps4000aMFile.m'
...
% PICO_STATUS _stdcall ps4000aSetChannel ( int16_t handle , PS4000A_CHANNEL channel , int16_t enabled , PS4000A_COUPLING type , PS4000A_RANGE range , float analogOffset ); 
fcns.name{fcnNum}='ps4000aSetChannel'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS4000AChannel', 'int16', 'enPS4000ACoupling', 'enPS4000ARange', 'single'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps4000aApplyResistanceScaling ( int16_t handle , PS4000A_CHANNEL channel , PS4000A_RANGE range , int16_t * bufferMax , int16_t * bufferMin , uint32_t buffertLth , int16_t * overflow ); 
fcns.name{fcnNum}='ps4000aApplyResistanceScaling'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS4000AChannel', 'enPS4000ARange', 'int16Ptr', 'int16Ptr', 'uint32', 'int16Ptr'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps4000aGetValuesTriggerTimeOffsetBulk ( int16_t handle , uint32_t * timesUpper , uint32_t * timesLower , PS4000A_TIME_UNITS * timeUnits , uint32_t fromSegmentIndex , uint32_t toSegmentIndex ); 
fcns.name{fcnNum}='ps4000aGetValuesTriggerTimeOffsetBulk'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32Ptr', 'enPS4000ATimeUnitsPtr', 'uint32', 'uint32'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps4000aGetValuesTriggerTimeOffsetBulk64 ( int16_t handle , int64_t * times , PS4000A_TIME_UNITS * timeUnits , uint32_t fromSegmentIndex , uint32_t toSegmentIndex ); 
fcns.name{fcnNum}='ps4000aGetValuesTriggerTimeOffsetBulk64'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'enPS4000ATimeUnitsPtr', 'uint32', 'uint32'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps4000aGetAnalogueOffset ( int16_t handle , PS4000A_RANGE range , PS4000A_COUPLING coupling , float * maximumVoltage , float * minimumVoltage ); 
fcns.name{fcnNum}='ps4000aGetAnalogueOffset'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS4000ARange', 'enPS4000ACoupling', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
