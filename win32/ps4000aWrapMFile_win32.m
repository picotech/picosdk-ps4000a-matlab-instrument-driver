function [methodinfo,structs,enuminfo,ThunkLibName]=ps4000aWrapMFile_win32
%PS4000AWRAPMFILE_WIN32 Create structures to define interfaces found in 'ps4000aWrap'.

%This function was generated by loadlibrary.m parser version  on Wed Jun 21 16:23:09 2017
%perl options:'ps4000aWrap.i -outfile=ps4000aWrapMFile_win32.m'
...
% extern PICO_STATUS _stdcall setTriggerConditions ( int16_t handle , int32_t * conditionsArray , int16_t nConditions , int32_t info ); 
fcns.name{fcnNum}='setTriggerConditions'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32Ptr', 'int16', 'int32'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall setTriggerDirections ( int16_t handle , int32_t * directionsArray , int16_t nDirections ); 
fcns.name{fcnNum}='setTriggerDirections'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32Ptr', 'int16'};fcnNum=fcnNum+1;
...
% extern PICO_STATUS _stdcall setPulseWidthQualifierConditions ( int16_t handle , int32_t * conditionsArray , int16_t nConditions , int32_t info ); 
fcns.name{fcnNum}='setPulseWidthQualifierConditions'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32Ptr', 'int16', 'int32'};fcnNum=fcnNum+1;
% extern PICO_STATUS  _stdcall setProbeInteractionCallback ( int16_t handle ); 
fcns.name{fcnNum}='setProbeInteractionCallback'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16'};fcnNum=fcnNum+1;
% extern PICO_STATUS  _stdcall hasProbeStateChanged ( int16_t handle , int16_t * probeStateChanged ); 
fcns.name{fcnNum}='hasProbeStateChanged'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int16Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS  _stdcall clearProbeStateChanged ( int16_t handle ); 
fcns.name{fcnNum}='clearProbeStateChanged'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getUserProbeInteractionsInfo ( int16_t handle , PS4000A_USER_PROBE_INTERACTIONS * probes , uint32_t * nProbes ); 
fcns.name{fcnNum}='getUserProbeInteractionsInfo'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS4000AUserProbeInteractionsPtr', 'uint32Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getNumberOfProbes ( int16_t handle , int32_t * numberOfProbes ); 
fcns.name{fcnNum}='getNumberOfProbes'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getUserProbeTypeInfo ( int16_t handle , int32_t probeNumber , int16_t * connected , int32_t * channel , int16_t * enabled , int32_t * probeName , int8_t * requiresPower , int8_t * isPowered ); 
fcns.name{fcnNum}='getUserProbeTypeInfo'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32', 'int16Ptr', 'int32Ptr', 'int16Ptr', 'int32Ptr', 'int8Ptr', 'int8Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getUserProbeRangeInfo ( int16_t handle , int32_t probeNumber , int32_t * probeOff , int32_t * rangeFirst , int32_t * rangeLast , int32_t * rangeCurrent ); 
fcns.name{fcnNum}='getUserProbeRangeInfo'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32', 'int32Ptr', 'int32Ptr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getUserProbeCouplingInfo ( int16_t handle , int32_t probeNumber , int32_t * couplingFirst , int32_t * couplingLast , int32_t * couplingCurrent ); 
fcns.name{fcnNum}='getUserProbeCouplingInfo'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32', 'int32Ptr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
% extern PICO_STATUS _stdcall getUserProbeBandwidthInfo ( int16_t handle , int32_t probeNumber , int32_t * filterFlags , int32_t * filterCurrent , int32_t * defaultFilter ); 
fcns.name{fcnNum}='getUserProbeBandwidthInfo'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int32', 'int32Ptr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
